                        ...
                        <div class="card card-details">
                            ...
                            <div class="gallery">
                                <div class="xzoom-container">
                                    <img class="xzoom" id="xzoom-default" src="{{ url('frontend/images/details.jpg') }}"
                                        xoriginal="{{ url('frontend/images/details.jpg') }}" />
                                    <div class="xzoom-thumbs">
                                        <a href="{{ url('frontend/images/details.jpg') }}"><img class="xzoom-gallery"
                                                width="128" src="{{ url('frontend/images/details.jpg') }}"
